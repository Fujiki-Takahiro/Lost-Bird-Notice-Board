...
似たような掲示板は複数あるので既存のアプリで必要なところも入れながら以下で差別化を図る。 -状況やタグで飼い主と保護、目撃の検索がかかりやすいようにする。 -必要事項の徹底 -line通知 -見た目はシンプルにわかりやすく

■ 機能候補

MVPリリースは、投稿、閲覧、コメントなど一般的なCRUD。 
まだ未定ですが本リリースはLine通知、位置情報やオートコンプリート

■ 機能の実装方針予定

Line通知、位置情報、オートコンプリート
